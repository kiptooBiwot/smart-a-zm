    ...
    <div class="">
      <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
          ...
          <!-- CTA -->
          <a
            class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-gray-100 bg-green-500 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
            href="#"
          >
            <div class="flex items-center">
              ...
              <span>Welcome to Spring App Backend</span>
            </div>
            <span>Get Started &RightArrow;</span>
          </a>
          <!-- Cards -->
          <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            <!-- Card -->
            <div
              class="flex items-center p-4 bg-white border border-gray-200 rounded-lg shadow-xs"
            >
              ...
              <div>
                ...
                <p class="text-lg font-semibold text-gray-700">508</p>
              </div>
            </div>
            <!-- Card -->
            <div
          ...
          <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div
              class="flex items-center p-4 bg-white border border-gray-200 rounded-lg shadow-xs"
            >
              <div class="p-3 mr-4 fill-purple-500 bg-purple-100 rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <div>
                <p class="mb-2 text-sm font-medium text-gray-600">
                  Types of Crops in Farm
                </p>
                <p class="text-lg font-semibold text-gray-700">4</p>
              </div>
            </div>
            <!-- Card -->
            <div
              class="flex items-center p-4 bg-white border border-gray-200 rounded-lg shadow-xs"
            >
              <div class="p-3 mr-4 fill-red-500 bg-red-100 rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <div>
                ...
                <p class="text-lg font-semibold text-red-500">Not Certified</p>
              </div>
            </div>
            <!-- Card -->
            <div
              class="flex items-center p-4 bg-white border border-gray-200 rounded-lg shadow-xs"
            >
              <div class="p-3 mr-4 fill-teal-500 bg-teal-100 rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <!--<div
                        ...
                        <div>
                          ...
                          <p class="text-xs text-gray-600">Runner</p>
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">$ 863.45</td>
          ...
          <!-- Charts -->
          <!-- <h2 class="my-6 text-2xl font-semibold text-gray-700">Charts</h2>
